...
$progOfStudy = ''; $progTitle = ''; $progLvl = ''; $awarded = ''; $classification = ''; $qualSought = ''; $transCertifOfficial = 'Shirley Congdon'; $transCertifPost = 'Pro-Vice-Chancellor (Learning and teaching)'; $transcertFurtherInfo = 'https://edocs.bradford.ac.uk'; $progHours = '1,200 total study hours  per full-time academic year (or pro rata for part-time study)'; $teachingInst = 'NAMAL College'; $awardInst = 'University of Bradford'; $langInstr = 'English'; $langAssmnt = 'English';
...
foreach($aryRollNosTrans as $i => $rollNoTrans){
	...
	$pdf->writeTranscript($transCertifPost, $transcertFurtherInfo, $aryExplTxt, $awarded, $teachingInst, $awardInst, $progOfStudy, $progTitle, $langInstr, $langAssmnt, $qualSought, $progHours, $progLvl, $studentName, $dtAwarded, $aryGradesTrans, $aryClassificationCutOffs, $blnLocalised);
